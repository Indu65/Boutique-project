...
export interface ApiNotificationNotification
  ...
  info: {
    description: 'User notifications for order updates and system messages';
  ...
  attributes: {
    ...
    relatedOrderId: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<
      ['order_status', 'system', 'promotion']
    > &
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sellerId: Schema.Attribute.String & Schema.Attribute.Required;
    shippingAddress: Schema.Attribute.JSON;
    status: Schema.Attribute.Enumeration<
      ['paid', 'accepted', 'delivered', 'cancelled']
    > &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_type: Schema.Attribute.Enumeration<['buyer', 'seller', 'admin']> &
